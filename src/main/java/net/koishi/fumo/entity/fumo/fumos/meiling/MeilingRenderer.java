...
public class MeilingRenderer extends FumoRenderer {
    public MeilingRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(FumoEntity pEntity) {
        return new ResourceLocation(Fumo.MODID, "textures/entity/meiling_entity.png");
    }
}
